...
var kibe_bags =  [
  ...
  kibe_bags.forEach(function (item, index) {
    event.remove({ id: 'kibe:' + item + "_sleeping_bag_from_sleeping_bag" });
  });
...
//╚════════════════════════════════════════╝	
	...
	event.remove({ id: 'kibe:sleeping_bag' });
	event.remove({ id: 'kibe:black_sleeping_bag' });
	event.remove({ id: 'kibe:brown_sleeping_bag' });
	event.remove({ id: 'kibe:cyan_sleeping_bag' });
	event.remove({ id: 'kibe:gray_sleeping_bag' });
	event.remove({ id: 'kibe:green_sleeping_bag' });
	event.remove({ id: 'kibe:light_blue_sleeping_bag' });
	event.remove({ id: 'kibe:light_gray_sleeping_bag' });
	event.remove({ id: 'kibe:lime_sleeping_bag' });
	event.remove({ id: 'kibe:magenta_sleeping_bag' });
	event.remove({ id: 'kibe:orange_sleeping_bag' });
	event.remove({ id: 'kibe:pink_sleeping_bag' }); 
	event.remove({ id: 'kibe:purple_sleeping_bag' });
	event.remove({ id: 'kibe:red_sleeping_bag' });
	event.remove({ id: 'kibe:white_sleeping_bag' });
	event.remove({ id: 'kibe:yellow_sleeping_bag' });
